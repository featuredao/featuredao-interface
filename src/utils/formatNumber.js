 ...
 */
export const percentToPermyriad = (percentValue) =>
  BigNumber.from(
 ...
 * Ref: https://math.fandom.com/wiki/Permyriad
 */
export const permyriadToPercent = (permyriadValue) =>
  permyriadValue
 ...
 */
export const percentToPermille = (percentValue) =>
  BigNumber.from(
 ...
 * Ref: https://math.fandom.com/wiki/Permille
 */
export const permilleToPercent = (permilleValue) =>
  permilleValue
 ...
 * Perbicent: x/200
 */
export const percentToPerbicent = (percentValue) =>
  BigNumber.from(
 ...
 * Perbicent: x/200
 */
export const perbicentToPercent = (perbicentValue) =>
  perbicentValue
    ? (BigNumber.from(perbicentValue).toNumber() / 2).toString()
    : '0'

export const fracDiv = (quotient, dividend) => {
  return parseFloat(quotient) / parseFloat(dividend)
}

const separateThousands = (str, separator = thousandsSeparator) => {
...
export const stripCommas = (string) => {
...
export const formattedNum = (
  ...
  function formatNearZero(formatted) {
    if (
      num?.toString().trim() &&
      formatted
        ?.split('')
